...
cmake -G "Visual Studio 17 2022" -A x64 -DCMAKE_INSTALL_PREFIX="." -DCMAKE_C_FLAGS="/DPCRE2_STATIC" -DCMAKE_CXX_FLAGS="/DPCRE2_STATIC" -DPCRE2_INCLUDE_DIR="%PCRE_ROOT%/include" -DPCRE2_LIBRARY="%PCRE_ROOT%/lib/pcre2-8-static.lib" -S . -B build
